var testJsonObject = [
    ...
    },
    {
      ...
      'articleLink': 'www.facebook.com',
      'articleImage': "image 3"

    },
    {
      'newsFeed': 'The Blazers Visit their Oldest Fan',
      'subHeader': 'Fan Zone',
      'content': 'Existem muitas variações das passagens do Lorem Ipsum disponíveis, mas a maior parte sofreu alterações de alguma forma, pela injecção de humor, ou de palavras aleatórias que nem sequer parecem suficientemente credíveis. Se vai usar uma passagem do Lorem Ipsum, deve ter a certeza que não contém nada de embaraçoso escondido no meio do texto. Todos os geradores de Lorem Ipsum na Internet acabam por repetir porções de texto pré-definido, como necessário',
      'articleLink': 'www.netflix.com',
      'articleImage': "image 4"
